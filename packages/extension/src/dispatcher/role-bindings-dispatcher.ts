...
import type { RoleBindingsData } from '@kubernetes-iam/channels';
import { ROLE_BINDINGS } from '@kubernetes-iam/channels';

@injectable()
export class RoleBindingsDispatcher
  extends AbsDispatcherObjectImpl<void, RoleBindingsData>
  implements DispatcherObject<void>
{
  constructor(
    ...
    super(rpcExtension, ROLE_BINDINGS);
  }

  getData(): RoleBindingsData {
    return this.dashboardStatesManager.getRoleBindings();
  }
}
