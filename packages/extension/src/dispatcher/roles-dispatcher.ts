...
@injectable()
export class RolesDispatcher extends AbsDispatcherObjectImpl<void, RolesData> implements DispatcherObject<void> {
  constructor(
    ...
    super(rpcExtension, ROLES);
  }

  getData(): RolesData {
    return this.dashboardStatesManager.getRoles();
  }
}
