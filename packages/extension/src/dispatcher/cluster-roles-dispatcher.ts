...
import type { ClusterRolesData } from '@kubernetes-iam/channels';
import { CLUSTER_ROLES } from '@kubernetes-iam/channels';

@injectable()
export class ClusterRolesDispatcher
  extends AbsDispatcherObjectImpl<void, ClusterRolesData>
  implements DispatcherObject<void>
{
  constructor(
    ...
    super(rpcExtension, CLUSTER_ROLES);
  }

  getData(): ClusterRolesData {
    return this.dashboardStatesManager.getClusterRoles();
  }
}
