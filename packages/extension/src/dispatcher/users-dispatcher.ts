...
import { USERS } from '@kubernetes-iam/channels';

@injectable()
export class UsersDispatcher extends AbsDispatcherObjectImpl<void, UsersData> implements DispatcherObject<void> {
  constructor(
    ...
    super(rpcExtension, USERS);
  }

  getData(): UsersData {
    return this.dashboardStatesManager.getUsers();
  }
}
